...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            <div class="m-b-md">
                <h3 class="form-headers">Create an Account</h1>
            </div>
            <div class="m-b-md">
                <div style="text-align: center">
                    <a href="/auth/facebook" class="btn btn-facebook btn-outline btn-lg btn-block"><i class="fa fa-facebook" aria-hidden="true" style="margin-right: 10px"></i> Connect with Facebook</a>
                </div>
            </div>
            ...
            <div class="m-b-md">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <label for="dob-day" class="control-label">Birthday</label>
